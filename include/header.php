                        ...
                        <div id="navbar" class="collapse navbar-collapse navigation-holder">
                            ...
                            <ul class="nav navbar-nav mb-2 mb-lg-0">
                                <li class="menu-item-has-children">
                                    <a class="" href="#">Home</a>
                                    <ul class="sub-menu">
                                        <li><a class="" href="index.php">Wedding Home 1</a></li>
                                        <li><a href="index-4.php">Announcement Home 2</a></li>
                                        <li><a href="index-5.php">Muslim Wedding Home</a></li>
                                        <li><a href="index-6.php">Asian Wedding Home</a></li>
                                ...
                                <li class="menu-item-has-children">
                                    ...
                                    <ul class="sub-menu">
                                        ...
                                        <li><a href="story-5.php">Our Story Style 3</a></li>
                                    </ul>
                                </li>
